				...
				<div class="col-sm-12 col-xl-12">
					<div class="bg-light rounded h-100 p-4">
						...
						<div class="mb-3">
							...
							<div class="input-group">
								<label class="col-sm-1 col-form-label">圖片上傳</label>
								<div class="col-sm-11">
									<input @change="filechange" type="file">
								</div>
							</div>
							<div class="input-group">
								<label class="col-sm-1 col-form-label">成本</label>
								<div class="col-sm-11">
							...
							<div class="input-group">
								<label class="col-sm-1 col-form-label">商品簡述</label>
								<div class="col-sm-11">
							...
							<div class="input-group">
								...
								<div class="col-sm-11">
									<div class="form-check" style="display: inline-block;">
                                        <input class="form-check-input" type="radio" name="status" id="status1" value="1" :checked="form.status == 1">
                                        <label class="form-check-label" for="status1">
                                            上架
                                        </label>　
                                    </div>
									<div class="form-check" style="display: inline-block;">
                                        <input class="form-check-input" type="radio" name="status" id="status0" value="0" :checked="form.status == 0">
...
<script>
	...
	export default {
		...
		mounted() {
			...
			if (this.$route.name === 'product_create') {
